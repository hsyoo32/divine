...
command_0807 = "python main.py --dataset 190808_n_SIDE_epiAmi_noEdit_noDeg1 --network-file ../../_Data/epinions_aminer_9_1.train " 
command_0807 += "--embed-dim 128 --epochs-to-train 20" #" --window-size {} --epochs-to-train 50 --regularization-param {}"
