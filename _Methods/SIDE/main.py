...
def parse_args():
  ...
  # HS revised
  parser.add_argument('--make_consistent', dest='make_consistent', action='store_false', default=True, help='make_consistent')
...
def main(args):
  ...
  read_config['make_consistent'] = args.make_consistent
  ...
  # nayoun revised
  embed_config['dataset'] = args.dataset
